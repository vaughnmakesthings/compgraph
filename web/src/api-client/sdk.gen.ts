 ...
 * Pipeline Runs
 */
export const pipelineRunsApiV1PipelineRunsGet = <ThrowOnError extends boolean = true>(options?: Options<PipelineRunsApiV1PipelineRunsGetData, ThrowOnError>) => (options?.client ?? client).get<PipelineRunsApiV1PipelineRunsGetResponses, PipelineRunsApiV1PipelineRunsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * List Auth Users
 */
export const listAuthUsersApiV1AdminAuthUsersGet = <ThrowOnError extends boolean = true>(options?: Options<ListAuthUsersApiV1AdminAuthUsersGetData, ThrowOnError>) => (options?.client ?? client).get<ListAuthUsersApiV1AdminAuthUsersGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
